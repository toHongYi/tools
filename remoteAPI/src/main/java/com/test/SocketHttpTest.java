...
/**
 * @ClassName SocketHttpTest
 * @Created by theLin
 * @Date 2021/12/15 23:37
...
public class SocketHttpTest {
    ...
    public SocketHttpTest(String host, int port) throws Exception{
    ...
    public static void main(String[] args) throws Exception {
         ...
         * https协议测试
         */
        SocketHttpTest forHttpTest = new SocketHttpTest("www.baidu.com", 443);
        try {
            forHttpTest.sendGet();
