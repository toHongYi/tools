...
public class onlyString02 {
    public static void main(String[] args) {
        ...
        String test2 = "oa接口.txt|http://172.15.7.109:8001/product/commonbase/v1/downloadFileByCt?sign=eyJmaWxlVGFibGUiOiJsY0NQUFNMQ19DUFhYIiwiZmlsZUNvbHVtbiI6IlFUIiwiaWQiOjMxMSwiZW50cnlObyI6";
        list.add(test);
        list.add(test1);
        list.add(test2);
...
//        JSONArray array222 = JSONArray.parseArray(JSON.toJSONString(jsonObject));
//        List<String> list2 = array222.toJavaList(String.class);
